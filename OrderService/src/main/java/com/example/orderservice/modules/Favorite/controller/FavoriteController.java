package com.example.orderservice.modules.Favorite.controller;

import com.example.orderservice.models.Favorites;
import com.example.orderservice.modules.Favorite.dto.CreateFavoriteDto;
import com.example.orderservice.modules.Favorite.service.FavoriteService;
...
@RestController
@RequestMapping("/orders/favorites")
@AllArgsConstructor
public class FavoriteController {
    private final FavoriteService favoriteService;

    @PostMapping("/new")
    public ResponseEntity<Favorites> createFavorite(CreateFavoriteDto createFavoriteDto) {
